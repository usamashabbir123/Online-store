...
export function SellerLayout({ children }: SellerLayoutProps) {
  ...
  const navigation = [
    { name: "Dashboard", href: "/seller/dashboard", icon: LayoutDashboard, current: true },
    { name: "Products", href: "/seller/products", icon: Package, current: false },
    { name: "Orders", href: "/seller/orders", icon: ShoppingCart, current: false, badge: "3" },
    { name: "Analytics", href: "/seller/analytics", icon: BarChart3, current: false },
    { name: "Store Settings", href: "/seller/store", icon: Store, current: false },
          ...
          <div className="flex flex-col h-full pt-20 lg:pt-0">
            ...
            <div className="p-4">
              <div className="bg-muted rounded-lg p-4">
                <h3 className="font-heading font-semibold text-sm mb-2">Store Status</h3>
                <div className="flex items-center gap-2 mb-2">
                  <div className="h-2 w-2 bg-green-500 rounded-full"></div>
                  <span className="text-xs text-muted-foreground">Active & Approved</span>
                </div>
                <p className="text-xs text-muted-foreground">Your store is live and accepting orders.</p>
              </div>
            </div>
          </div>
        </aside>
